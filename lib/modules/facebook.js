...
oauthModule.submodule('facebook')
  ...
  .apiHost('https://graph.facebook.com/v2.7')
  .oauthHost('https://graph.facebook.com/v2.7')

  .authPath('https://www.facebook.com/v2.7/dialog/oauth')
...
fb.mobile = function (isMobile) {
  if (isMobile) {
    this.authPath('https://m.facebook.com/v2.7/dialog/oauth');
  }
  return this;
};
